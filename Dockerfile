...
RUN yum update -y && yum install -y gcc-c++ make shadow-utils
...
RUN groupadd -r travelagent && useradd -m -r -g travelagent travelagent && chown -R travelagent:travelagent /app
